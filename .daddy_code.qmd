...
Modell för citronhajars metabolism baserat på sambandet mellan simhastighet och syreförbrukning (som väger 1kg).
...
```{r}
L_av_t <- function(t) { # Kräver insättning av siffror!!!
  L_av_t <- L_inf + (L_noll - L_inf) * exp(-k*t)
}
```
...
![](Livstabell caretta caretta.png)
...
![](Leslie-Lefkovitch matte.png)

![](Leslie-Lefkovitch förklaring.png)
