...
Residualanalysen (@fig-7.1) visade på lika varians och normalfördelning. Analysen indikerade en skillnad i höjdtillväxt (F(3) = 3.947, p = 0.0113) beroende på nivå av klippning.
...
Större del av uppäten bladyta leder till lägre höjdtillväxt (@tbl-7.1).
